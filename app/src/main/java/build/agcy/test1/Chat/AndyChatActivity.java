...
//        super.onBackPressed();
//        overridePendingTransition(R.animator.comming_in, R.animator.comming_out);
//    }
	...
	//	receiveMsg();
        ...
        EditText input = (EditText) findViewById(R.id.txt_inputText);
