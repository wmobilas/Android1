...
import com.agcy.eatwithme.Core.Helpers.OnBackPressedListener;
import com.agcy.eatwithme.Fragments.LocationDialogFragment;
import com.agcy.eatwithme.Fragments.MapFragment;
import com.agcy.eatwithme.Meetings.CreateMeetingFragment;
...
public class MainActivity extends CrashCatcherActivity
    ...
    public static Typeface getTypeface(Context c) {
        Typeface typeface = Typeface.createFromAsset(c.getAssets(), "fonts/fredok.ttf");
        return typeface;
    }
...
//        actionBar.setTitle(mTitle);
        ...
        actionBarCustomizations();
    }

    public void actionBarCustomizations() {
        ActionBar actionBar = getActionBar();
        if (actionBar != null) {
            actionBar.setLogo(R.drawable.trsprnt);
            actionBar.setIcon(R.drawable.trsprnt);
            actionBar.setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM | ActionBar.DISPLAY_SHOW_HOME | ActionBar.DISPLAY_HOME_AS_UP);
            LayoutInflater inflator = LayoutInflater.from(this);
            View v = inflator.inflate(R.layout.actionbar, null);
            TextView actionBarTitleTextView = (TextView) v.findViewById(R.id.apptitle);
            actionBarTitleTextView.setTypeface(getTypeface(this));
